package com.dev.mealsOnWheel.oauth2security;
...
public class AuthorizationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler{
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        Optional<String> redirectUri = CookieUtils.getCookie(request, com.dev.mealsOnWheel.oauth2security.HttpCookieAuthorizationRequestRepo.REDIRECT_URI_PARAM_COOKIE_NAME)
                .map(Cookie::getValue);
